...
/* harmony import */ var _modules_openImg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/openImg */ "./src/js/modules/openImg.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_openImg__WEBPACK_IMPORTED_MODULE_6__["default"])();
...
var checkNumberInputs = function checkNumberInputs(selector) {
  var nunInputs = document.querySelectorAll(selector);
  nunInputs.forEach(function (item) {
...
var forms = function forms(state) {
  ...
  var clearStateObj = function clearStateObj(modalState) {
    for (key in modalState) {// TODO: clear object of state
    }
  };
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      if (item.getAttribute('data-calc') === "final") {
        //в форме калькулятора добавляем к имени и телефону данные про окно
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    //closeClickOverlay не дает закрытья по клику на серой области
